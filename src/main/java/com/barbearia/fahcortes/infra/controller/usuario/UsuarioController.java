...
public class UsuarioController {
    ...
    public UsuarioController(UsuarioMapper usuarioMapper,
                             ...
                             DeletarUsuarioPorIdUseCase deletarUsuarioPorIdUseCase,
                             AtualizarUsuarioPorIdUseCase atualizarUsuarioPeloIdUseCase,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UsuarioResponseDto> atualizarUsuario(@RequestBody @Valid UsuarioRequestDto usuarioRequestDto,
